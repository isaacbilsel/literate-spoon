# Recipe Recommendation Backend# literate-spoon

CSCI 6221 Course Project

A Flask-based API that combines **Google Gemini AI** and **Spoonacular API** to generate personalized recipe recommendations based on user health metrics, dietary preferences, and allergies.
